...
//Application Title
define('APP_TITLE', 'STICKnoLOGIC FileManager');
...
$favicon_path = 'https://cdn.sticknologic.is-a.dev/profile.png';
                ...
                <div class="row justify-content-md-center align-content-center h-100vh">
                    <div class="card-wrapper">
                        <div class="card fat" data-bs-theme="<?php echo FM_THEME; ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                        <div class="brand">
                                            <img src="<?php echo fm_enc($favicon_path) ?>" width="50">
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://sticknologic.is-a.dev/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">STICKnoLOGIC</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="https://github.com/sticknologic/tinyfilemanager" target="_blank" class="app-v-title"> STICKnoLOGIC FileManager <?php echo VERSION; ?></a></h3>
                        </p>
                        <p>Author: PRAŚATH MANİ</p>
                        <p>Mail Us: <a href="mailto:tinyfilemanger@sticknologic.is-a.dev">tinyfilemanager [at] sticknologic [dot] is-a [dot] dev</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://github.com/sticknologic/tinyfilemanager/wiki" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
